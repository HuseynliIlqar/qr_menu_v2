...
class IndexSliderPhotoModel(models.Model):
    ...
    slide_image = models.ImageField(upload_to='index_slider_photos/', blank=True, null=True)
    slide_image_url = models.CharField(max_length=500, blank=True)
    ...
    @property
    def slide_image_src(self):
        if self.slide_image:
            return self.slide_image.url
        return self.slide_image_url or ''
